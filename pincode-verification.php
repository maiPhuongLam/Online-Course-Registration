...
if (strlen($_SESSION['login']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($num > 0) {
      ...
      $_SESSION['msg'] = "  Lỗi: Vui lòng nhập mã PIN hợp lệ!";
    }
  }
?>
  ...
  <body>
    ...
    <div class="content-wrapper">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="page-head-line">Sinh viên xác nhận mã PIN</h1>
          </div>
        </div>
        <div class="row">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form name="pincodeverify" method="post">
                  ...
                  <button type="submit" name="submit" class="btn btn-default">Kiểm tra</button>
                  <hr />
