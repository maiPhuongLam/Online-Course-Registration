  ...
  <body>
    ...
    <div class="content-wrapper">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="page-head-line">THÔNG TIN CÁ NHÂN </h1>
          </div>
        </div>
        <div class="row">
              ...
              while ($row = mysqli_fetch_array($sql)) { ?>
                ...
                <div class="panel-body">
                  <form name="dept" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label for="studentregno">MSSV </label>
                    ...
                    <div class="form-group">
                      <label for="Pincode">Chọn ảnh mới </label>
                  ...
                  <button type="submit" name="submit" id="submit" class="btn btn-default">Cập nhật</button>
                  </form>
                </div>
            </div>
          </div>
